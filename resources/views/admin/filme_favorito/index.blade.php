...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Filmes favoritos</div>
                    <div class="card-body">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="search" placeholder="Titulo, Ano ou Diretor ..." value="{{ request('search') }}">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Titulo</th><th>Ano</th> <th>Diretor</th><th>Pessoa</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($filme_favorito as $item)
                                            <tr>
                                                <td>{{ $item->id }}</td><td>{{ $item->titulo }}</td><td>{{ $item->ano }}</td><td>{{ $item->diretor }}</td>
                                                @foreach($pessoa as $p)
